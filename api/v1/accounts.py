...
from core.accounts.views import AccounUpgradeViewV1,AccountPaymentsViewV1,TradingAccountsViewV1
...
urlpatterns = [
    ...
    path('trading/',TradingAccountsViewV1.as_view(),name='account-trading'),
]